...
pipeline {
    ...
    */
    environment {
        EXP_BASE_NAME = "conf-logprobsgreedydiff"
    ...
    parameters {
            ...
            */
            ...
            choice name: 'LOSS_FILTER',
                choices: ['all', 'fwd', 'back', 'fwdplusback', 'fwdmultback'],
        ...
        stage("Run combos in parallel."){
            ...
            environment{
                ...
                */
                ...
                PY_EXP_ARGS="${WRITER_ARG} ${BATCH_ARG} ${BATCH_ARG} ${STEPS_ARG} ${ALIGN_ARG} ${LOSS_ARG}"
