    ...
    stages {
        ...
        stage("Run combos in parallel."){
            ...
            environment{
                ...
                */
                DOCKER_NAME="${EXP_BASE_NAME}-${EXP_SCRIPT}-${DATA}-\${ALIGNMENT}-\${PROCEDURE}-\${DECODER}-${JOB_TYPE}"
                ...
                PY_EXP_ARGS="${WRITER_ARG} ${BATCH_ARG} ${BATCH_ARG} ${STEPS_ARG} ${ALIGN_ARG} ${PROCEDURE_ARG}"
