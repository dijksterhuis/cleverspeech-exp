        ...
        stage("Run all combos in parallel."){
            ...
            matrix {
                ...
                environment {
                    ...
                    DOCKER_NAME="${EXP_BASE_NAME}-${BUILD_ID}-\${GRAPH}-\${LOSS}"
                    ...
                    GRAPH_ARG="--graph \${ALIGNMENT}"
                    LOSS_ARG="--loss \${LOSS}"
                    WRITER_ARG="--writer ${params.WRITER}"
                    DECODER_ARG="--decoder ${params.DECODER}"
                    PY_EXP_ARGS="${WRITER_ARG} ${BATCH_ARG} ${STEPS_ARG} ${GRAPH_ARG} ${LOSS_ARG} ${DECODER_ARG}"
