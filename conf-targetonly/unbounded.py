...
LOSS_CHOICES = {
    "logits": Losses.MaximiseTargetFramewiseActivations,
    "softmax": Losses.MaximiseTargetFramewiseSoftmax,
}
...
def attack_run(master_settings):
    ...
    outdir = os.path.join(outdir, "unbounded/confidence/targetonly/")
