...
pipeline {
    ...
    */
    environment {
        ...
        DOCKER_NAME="${EXP_BASE_NAME}-${params.EXP_SCRIPT}-${DATA}-${params.LOSS}-${params.DECODER}-${params.JOB_TYPE}"
        ...
        PY_EXP_ARGS="${WRITER_ARG} ${BATCH_ARG} ${BATCH_ARG} ${STEPS_ARG} ${LOSS_ARG}"
    ...
    parameters {
        ...
        */
        ...
        choice name: 'LOSS',
            choices: ['ctc', 'ctc2'],
            description: 'Filter experiments based on loss hyper parameter. Default: ctc.'
